...
if __name__ == '__main__':
    ...
    # 계좌 3개 추가
    dao.insert_account(Account('111111', 'sungsoo', 10000, '1234'))
    dao.insert_account(Account('111112', 'sooyaaa', 20000, '1234'))
    dao.insert_account(Account('111113', 'sooyaaa', 200000, '1234'))
    ...
    # 특정 회원의 계좌 목록 조회
    print('--- sungsoo 회원의 계좌 목록 ---')
    for account in dao.select_accounts_by_member_id('sungsoo'):
        print(account)
    ...
    # 특정 계좌 수정
    dao.update_account('111112', Account('111112', 'sooyaaa', 300000, '1234'))
